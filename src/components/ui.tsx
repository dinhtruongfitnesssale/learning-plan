...
// py-3 trên điện thoại cho đủ vùng chạm; whitespace-nowrap để chữ trong
// nút luôn nằm 1 dòng (hẹp quá thì xếp mỗi dòng 1 nút bằng class .btn-row).
const buttonBase =
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full px-5 py-3 sm:py-2.5 text-sm font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed";
